...
public class GenServiceImpl implements GenService {
    ...
    private HashMap<String, List<Column>> getColumnsFromMetaTable(JDBCUtils.MetaTable metaTable) {
        ArrayList<Column> columnList = new ArrayList<>();
        ArrayList<Column> pkColumnList = new ArrayList<>();
        List<JDBCUtils.MetaColumn> columns = metaTable.getColumns();
        for (JDBCUtils.MetaColumn metaColumn : columns) {
            // Column转化
