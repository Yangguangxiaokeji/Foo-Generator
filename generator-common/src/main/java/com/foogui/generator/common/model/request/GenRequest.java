package com.foogui.generator.common.model.request;
...
public class GenRequest {
    ...
    /**
     * 生成的框架类型（Mybatis或MybatisPlus）
     */
    @NotNull(message = "必须选择生成哪种技术框架", groups = {ValidGroup.Database.class})
