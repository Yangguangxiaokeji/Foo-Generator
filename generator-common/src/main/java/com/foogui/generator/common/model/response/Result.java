package com.foogui.generator.common.model.response;

import com.foogui.generator.common.enums.ErrorCode;
...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> fail(Throwable ex, T data) {
        ...
        result.setMessage(ex != null ? ex.getMessage() : ErrorCode.FAIL.getMessage());
        result.setTimestamp(LocalDateTime.now().format(DateTimeFormatter.ofPattern(DATE_PATTERN)));
        result.setData(data);
        return result;
    }
